...
- **Animation Library**: Upload your own `.vrma` motions, describe them, and let her use them. She can trigger one gesture per reply when it fits, and the built-in emotes come described out of the box
